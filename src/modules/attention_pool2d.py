...
class VariableAttentionPool2d(nn.Module):
    ...
    def __init__(
        ...
        # feat_size is the maximum feature size restraint by given STYLE_MAX_WIDTH parameter in config
    ...
    def forward(self, x):
        ...
        x = x + self.pos_embed.unsqueeze(0)[:, : (N + 1)].to(x.dtype)
